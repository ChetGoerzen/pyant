...
def write_antelope_db(db_path, origin, arrival, site, algorithm, auth_name):
    ...
    can be applied to the data. The assoc file contains the required information
    to relate an event to it's picks.
    ...
    arrival : pd.DAtaFrame()
        ...
        - phase: A str describing the phase type of a given arrival, must be P or S

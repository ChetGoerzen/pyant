...
class PickViewData:
    ...
    def correct_events(self):
        ...
        correct_events = out_df[out_df.status == 'correct']
        correct_events.drop_duplicates(subset="orid", inplace=True)
    ...
    def review_events(self):
        ...
        review_events = out_df[out_df.status == 'review']
        review_events.drop_duplicates(subset="orid", inplace=True)
    ...
    def false_events(self):
        ...
        false_events = out_df[out_df.status == 'false']
        false_events.drop_duplicates(subset="orid", inplace=True)
    ...
    def correct_origin(self):
        ...
        correct_origin = origin[origin["orid"].isin(correct_events["orid"])]
        correct_origin.drop_duplicates(subset="orid", inplace=True)
    ...
    def review_origin(self):
        ...
        review_origin = origin[origin["orid"].isin(review_events["orid"])]
        review_origin.drop_duplicates(subset="orid", inplace=True)
    ...
    def false_origin(self):
        ...
        false_origin = origin[origin["orid"].isin(false_events["orid"])]
        false_origin.drop_duplicates(subset="orid", inplace=True)
    ...
    def review_arrival(self):
        ...
        review_arrival.drop_duplicates(subset="datetime", inplace=True)
        review_arrival.reset_index(inplace=True, drop=True)
        
        return review_arrival
...
def write_antelope_db_from_pick_view(db_path, data_path, category_of_picks='correct'):
